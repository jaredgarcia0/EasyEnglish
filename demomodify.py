...
# game variables
# word_adjective = load_words('es-en_adjective.csv')
# word_communication = load_words('es-en_communication.csv')
# word_food = load_words('en-es_food.csv')
# word_health = load_words('en-es_health.csv')
# word_orientation = load_words('en-es_orientation.csv')
# word_personal = load_words('en-es_personal.csv')
# word_sentences = load_words('en_es-sentences.csv')
# word_shopping = load_words('en-es_shopping.csv')
# word_surrounding = load_words('en-es_surrounding.csv')
# word_time = load_words('en-es_time.csv')
# word_transport = load_words('en-es_transport.csv')
# word_verb = load_words('en-es_verb.csv')
